...
from pyspark.sql.types import StructType, StructField, StringType, LongType, DoubleType, TimestampType, MapType, IntegerType
...
class SparkMetricsLogger:
    def __init__(self, table_path="/lakehouse/dst/system/metrics/activity_log", spark=None):
